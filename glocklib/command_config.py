...
from glocklib.formats import human_bool
from glocklib.selection import FilterType
...
class CommandSettings(commands.Cog):
    ...
    async def admin(self, ctx: Context, role: discord.Role = None):
        """
        Set's a role for complete Marimba access.
    ...
    async def manager(self, ctx: Context, role: discord.Role = None):
        """
        Set's a role for moderate Marimba access.
