...
class BotHelpPageSource(menus.ListPageSource):
    ...
    def __init__(self, help_command, cogs_commands, top):
    ...
    async def format_page(self, menu, cogs):
        ...
        embed.set_author(name='Help', url=context.bot.user.avatar_url)
...
class GroupHelpPageSource(menus.ListPageSource):
    ...
    async def format_page(self, menu, group_commands):
        ...
        embed.set_author(name='Help', url=bot.user.avatar_url)
        maximum = self.get_max_pages()
        if maximum > 1:
...
async def create_embed(command, guild):
    ...
    if guild is None:
        ...
        prefix.append(await command.context.bot.get_guild_prefix(guild))
...
class HelpCommand(commands.HelpCommand):
    ...
    def __init__(self, *, top=None):
        ...
        if top:
            ...
            self.top = '`help [command/category]` for more specific help.'
    ...
    async def send_bot_help(self, mapping):
        ...
        menu = HelpMenu(BotHelpPageSource(self, all_commands, top=self.top))
    ...
    async def send_command_help(self, command: commands.Command):
        ...
        embed.set_author(name='Help', url=self.context.bot.user.avatar_url)
